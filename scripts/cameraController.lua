...
function cameraController:update(dt) 
  ...
  if objects.player.body:getY() - cameraOffSetY - self.forward.y > -50 and objects.player.body:getY() - cameraOffSetY - self.forward.y < 50 or p.invencibleTimeLeft > 1 then
